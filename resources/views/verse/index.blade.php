...
<!--</div>-->
    ...
    <div class="card">
        ...
        <p class="text-secondary" style="margin-bottom: 1rem; font-size: 0.9rem;">{{ Str::limit($data->description, 60) }}</p>
        ...
        <a href="{{ route('verse.show', $data->id) }}" class="btn btn-secondary" style="text-decoration: none;">View</a>
        @endif
        </div>
    ...
    <div class="card text-center">
        ...
        <p class="text-secondary">No Memory Verse available at the moment.</p>
    </div>
    @endforelse
</div>
