...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <form action="{{ route('admin.prayer.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <textarea name="prayerpoints" class="form-control" rows="12" required>{{ old('prayerpoints', $data->prayerpoints) }}</textarea>
                </div>
