...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient(90deg, rgb(110, 29, 253) 60%, rgb(69, 123, 252) 100%);">
        ...
        <!-- Nav Item - Reports -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.prayer.index') }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Quiz App 2026</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
