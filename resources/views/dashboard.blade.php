...
<div class="container content-with-nav">
    ...
    <div class="card">
        <h3 style="font-size: 1.1rem; font-weight: 700; margin-bottom: 0.5rem;">{{ $quiz->title }}</h3>  <h5 style="font-size: 1.1rem; font-weight: 500; margin-bottom: 0.5rem;float: right;">{{ $quiz->created_at->format('d-M') }}</h5>
